function author() {
    ...
    if (document.querySelector('#username') != null) {
        ...
        if (x === null || x === '') {
            ...
            document.querySelector('#username').style.borderRadius = '4%';
            check = false;
        } else {
            if (BTCQUSER.test(x) === false) {
                document.querySelector('#invalid-username').innerHTML = 'Tài khoản phải từ 2 - 50 ký tự, không chứa ký tự đặc biệt';
                document.querySelector('#invalid-username').style.visibility = 'visible';
                document.querySelector('#username').style.border = '2px solid red';
                document.querySelector('#username').style.borderRadius = '4%';
                check = false;
    ...
    if (document.querySelector('#address') != null) {
        ...
        if (x === null || x === '') {
            ...
            document.querySelector('#address').style.borderRadius = '4%';
            check = false;
        } else {
    ...
    if (document.querySelector('#phone_no') != null) {
        ...
        if (x === null || x === '') {
            ...
            document.querySelector('#phone_no').style.borderRadius = '4%';
            check = false;
        } else {
    ...
    if (document.querySelector('#posts') != null) {
        ...
        if (x === null || x === '') {
            ...
            document.querySelector('#posts').style.borderRadius = '4%';
            check = false;
        } else {
    ...
    if (document.querySelector('#level') != null) {
        ...
        if (x === null || x === '') {
            ...
            document.querySelector('#level').style.borderRadius = '4%';
            check = false;
        } else {
    ...
    if (document.querySelector('#b_account_no') != null) {
        ...
        if (x === null || x === '') {
            ...
            document.querySelector('#b_account_no').style.borderRadius = '4%';
            check = false;
        } else {
...
function platform() {
    ...
    if (x === null || x === '') {
        ...
        document.querySelector('#platform_name').style.borderRadius = '4%';
        check = false;
    } else {
...
function login() {
    ...
    if (x === null || x === '') {
        ...
        document.querySelector('#pass').style.borderRadius = '4%';
        check = false;
    } else {
        document.querySelector('#invalid-pass').innerHTML = 'ok';
        document.querySelector('#invalid-pass').style.visibility = 'hidden';
...
function news() {
    ...
    if (x === null || x === '') {
        ...
        document.querySelector('#content').style.borderRadius = '4%';
        check = false;
    } else {
