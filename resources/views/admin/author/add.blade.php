        ...
        <div class="form">
            <form action="{{ route('post-add-author') }}" method="post" onsubmit="return author()">
                ...
                <div class="div-input">
                    ...
                    <input type="tel" placeholder="012-345-6789" pattern="[0]{1}[0-9]{9}" name="phone_no" id="phone_no" class="input">
                ...
                <div class="div-input">
                    ...
                    <input type="tel" pattern="[0-9]{14}" name="b_account_no" id="b_account_no" class="input">
